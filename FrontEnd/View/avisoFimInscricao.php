                ...
                <div class="content-wrapper">
                    ...
                    <div class="content">
                        ...
                        <div class="text-center content-group">
                            <h1 class="error-title offline-title" id="contador" style="font-size: 70px !important;">Atenção inscrições encerradas!</h1>
                            <h1>Pré-cadastro ocorreu do dia 24/04/2019 até o dia 08/05/2019</h1>
                        </div>
                        <!-- /error title -->
                        <!-- Error content -->
